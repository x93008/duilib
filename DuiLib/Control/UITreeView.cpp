...
namespace DuiLib
{
	...
	// 参数信息: int iIndex				该参数代表在当前节点下的第几个位置，其他参数列表不可见
	// 函数说明: 
	//************************************
