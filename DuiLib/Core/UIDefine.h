...
struct DUI_MSGMAP_ENTRY //Define a structure to store message information
{
	CDuiString sMsgType;          // DUI message type
	CDuiString sCtrlName;         // Control name
	UINT       nSig;              // Signature function pointer
	DUI_PMSG   pfn;               // Function pointer
};
